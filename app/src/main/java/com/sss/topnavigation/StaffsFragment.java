...
import static com.sss.topnavigation.helper.util.baseURL;
...
public class StaffsFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View v = getView();
        View RootView = inflater.inflate(R.layout.fragment_staffs, container, false);
        assert v != null;
        listView = (ListView)RootView.findViewById(R.id.listViewStaffs);
        getJSON();
...
//                Toast.makeText(getApplicationContext(), s, Toast.LENGTH_LONG).show();
    ...
    private void loadIntoListView(String json) throws JSONException
    {
        ...
        for (int i = 0; i < jsonArray.length(); i++)
        {
            ...
            orginfo[i] = intro.getString("staffs");
        }
